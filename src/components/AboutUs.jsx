    ...
    <div className="flex flex-col px-24 pb-20">
      <div className="flex justify-between items-center pb-20">
        <div className="flex flex-col gap-10 text-start">
          <h1 className="text-[50px] leading-[76px] font-bold text-bg">
            About Us
          </h1>
          <span className="text-[20px] leading-[32px] text-[#64717C]">
            At Besnik Consultancy, we take pride in our values <br />– service,
            integrity, and excellence.
          </span>
        </div>
        <button className="bg-[#F4F6F6] text-[#5f5f64] text-[18px] font-semibold py-[15px] px-[34px] rounded-2xl shadow-2xl">
          Learn more
        </button>
      </div>
